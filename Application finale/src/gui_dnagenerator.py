...
class WDnaGenerator(tk.Frame):
    ...
    def createWidget(self):
        ...
        self.textLbl=tk.Label(self, text="Taille de la séquence d'ADN : ")
        ...
        self.textLbl=tk.Label(self, text="Séquence d'ADN originale")
        self.textLbl.grid(row=2,column=0, rowspan=2)
    ...
    def erreurCmd(self, s):
        ...
        tk.Label(self.t, text="Error: Invalid input %s" % s).pack(padx=5, pady=5)
        tk.Button(self.t, text="Ok", command=self.t.destroy).pack(padx=5, pady=5)
